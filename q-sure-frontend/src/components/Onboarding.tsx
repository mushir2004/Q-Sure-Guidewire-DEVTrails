            ...
            >
                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                {platforms.map(p => (
                                    <button
                                        ...
                                        className={`glass-button py-4 ${selectedPlatform === p ? 'bg-purple-600/50 border-purple-500/50' : ''}`}
                                    >
                                        {p}
                                    </button>
                                ))}
                        ...
                        <button
                            onClick={nextStep}
                            disabled={step === 2 && !selectedPlatform}
                            className="glass-button bg-purple-600/50 hover:bg-purple-600/70 border-purple-500/50 mt-4 disabled:opacity-50"
                        >
